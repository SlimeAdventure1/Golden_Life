...
export default {
  ...
  methods: {
    ...
    sortStyle(selected) {
      return {
        "--bg": selected ? "var(--color-reality)" : ""
      };
    },
    timestampStyle(key) {
      return {
        "--bg": this.timestampMode === AUTOMATOR_EVENT_TIMESTAMP_MODE[key] ? "var(--color-reality)" : ""
      };
    },
    clearRealityStyle() {
      return {
        "--bg": this.clearOnReality ? "var(--color-reality)" : ""
      };
    },
    clearRestartStyle() {
      return {
        "--bg": this.clearOnRestart ? "var(--color-reality)" : ""
      };
    },
