...
const propList = {
  AD: ["purchase", "dimboost", "sacrifice", "discoveredDim", "achievementMult", "achievement", "infinityUpgrade",
...
const removedRegexes = ["AD_sacrifice", "discoveredDim", "AD_breakInfinityUpgrade", "AD_nerfIC", "AD_infinityUpgrade", "AD_v",
