...
export const alchemyResources = {
  ...
  "alternation": {
    ...
    uiOrder: 4,
    unlockedAt: 12,
    description: "increases the strength of Tachyonic Galaxies based on Replicanti",
    formatEffect: value => `Tachyonic Galaxies are ${formatPercents(value, 2, 2)} stronger
  ...
  "effarig": {
    ...
    formatEffect: value => `Relic Shard gain is increased by ${formatX(value, 2, 2)}`
  },
  "synergism": {
